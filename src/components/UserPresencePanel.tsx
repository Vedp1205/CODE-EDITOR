...
export function UserPresencePanel({ users }: UserPresencePanelProps) {
  const now = Date.now();

  return (
    <div className="w-64 bg-slate-900/80 backdrop-blur-xl border-l border-white/10 flex flex-col h-full">
      {/* Header */}
